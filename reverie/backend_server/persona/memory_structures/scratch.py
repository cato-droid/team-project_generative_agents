...
class Scratch: 
  def __init__(self, f_saved, currently_input): #FIXME input to be added to currently when starting the sim 
    ...
    if check_if_file_exists(f_saved): 
      ...
      currently_prompt += f"And give my back only that new text that describes what they are working on currently\n"
      currently_prompt += f"If that line is empty, just give back what they are working on currently unedited\n"
      print("\nprompt to llm:\n")
